...
#     # In your Ren'Py init python block
...
#         if parent_id:
#             new_state["parent_id"] = parent_id
#         if element_kind:
#             new_state["element_kind"] = element_kind
        
#         # ... (rest of your state replacement logic remains the same)
...
#         global companion_active_states, sync_deferred
#         # Use slice assignment to ensure Ren'Py rollback tracks the change to the list
